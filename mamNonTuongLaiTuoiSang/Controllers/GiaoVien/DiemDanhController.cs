...
namespace mamNonTuongLaiTuoiSang.Controllers.GiaoVien
{
        ...
        public async Task<IActionResult> Index(string sortOrder, string searchQuery)
        {
            ...
            try
            {
                    ...
                    if (!string.IsNullOrEmpty(searchQuery))
                    {
                        ...
                        diemdanhs = diemdanhs
                            .Where(dd => dd.IdHs.ToString().Contains(searchQuery) ||
                                         ...
                                         dd.Thang.ToString().Contains(searchQuery))
                            .ToList();
                ...
                diemdanhs = sortOrder switch
                {
                    ...
                    "thang_asc" => diemdanhs.OrderBy(dd => dd.Thang).ToList(),
                    "thang_desc" => diemdanhs.OrderByDescending(dd => dd.Thang).ToList(),
